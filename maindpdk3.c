...
static const char *MBUF_FRAGMENT_POOL = "MBUF_FRAGMENT_POOL";
...
long int GenerateData8_count = 0;
...
main(int argc, char **argv)
{
	...
	mbuf_fragment_pool = rte_pktmbuf_pool_create("MBUF_FRAGMENT_POOL", NUM_MBUFS,
	...
	rte_eal_remote_launch(Data_Distribute_Loop, NULL,9);
